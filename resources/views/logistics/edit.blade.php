...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Crear logistico') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('logistics.store') }}">
                        @csrf
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Nombre del logistico') }}</label>
                            <div class="col-md-6">
